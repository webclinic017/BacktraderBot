...
class StrategyOptimizationFactory(object):
    ...
    _BKTEST_FILTERS = FilterSequence([_BKTEST_TOTAL_CLOSED_TRADES_VALUE_FILTER, _BKTEST_MAX_DRAWDOWN_PCT_VALUE_FILTER, _BKTEST_NET_PROFIT_VALUE_FILTER, _BKTEST_EQUITY_CURVE_ANGLE_VALUE_FILTER, _BKTEST_EQUITY_CURVE_R_VALUE_FILTER, _BKTEST_MAX_DRAWDOWN_PCT_TOP_N_PCT_VALUE_FILTER])
    ...
    _FWTEST_EQUITY_CURVE_R_VALUE_FILTER = ValueFilter("FwTest: Equity Curve R-value", 0.7, False)

    _FWTEST_FILTERS = FilterSequence([_FWTEST_TOTAL_CLOSED_TRADES_VALUE_FILTER, _FWTEST_EQUITY_CURVE_ANGLE_VALUE_FILTER, _BKTEST_EQUITY_CURVE_R_VALUE_FILTER, _FWTEST_EQUITY_CURVE_R_VALUE_FILTER])
