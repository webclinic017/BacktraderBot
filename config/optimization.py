...
class StrategyOptimizationFactory(object):
    ...
    _STEP4_EQUITY_CURVE_R_VALUE_FILTER = ValueFilter("FwTest: Equity Curve R-value", 0.5, False)

    _STEP4_COMBINED_EQUITY_CURVE_R_VALUE_FILTER = ValueFilter("FwTest: Combined Equity Curve R-value", 0.75, False)
