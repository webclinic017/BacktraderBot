...
class StrategyOptimizationFactory(object):
    ...
    _STEP2_EQUITY_CURVE_R_VALUE_FILTER = ValueFilter("Equity Curve R-value", 0.6, False)
    ...
    _STEP4_NET_PROFIT_VALUE_FILTER = ValueFilter("Net Profit, %", 130, False)

    _STEP4_NET_PROFIT_TO_MAXDD_VALUE_FILTER = ValueFilter("FwTest: Net Profit To Max Drawdown", 0.4, False)

    _STEP4_EQUITY_CURVE_R_VALUE_FILTER = ValueFilter("Equity Curve R-value", 0.97, False)
